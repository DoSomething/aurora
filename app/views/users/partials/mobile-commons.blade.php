		...
		<article class="figure -left">
			@if (!empty($mc_profile))
				...
				<dl class="profile-settings">
					...
					{{ !empty($mc_profile['opted_out_at']) ? ('<dt>Opted Out On:</dt><dd>' . e(time_formatter($mc_profile['opted_out_at']))) : "" }}
					{{ !empty($mc_profile['opted_out_source']) ? ('<dt>Opted Out Source:</dt><dd>' . e($mc_profile['opted_out_source'])) : "" }}
